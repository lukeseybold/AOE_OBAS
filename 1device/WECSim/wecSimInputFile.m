...
simu.simMechanicsFile = 'AOE_1device.slx';     % Specify Simulink Model File
...
% Float ("\Float.ini")
body(1) = bodyClass('hydroData/AOE_1device.h5');      
    % Create the body(1) Variable, Set Location of Hydrodynamic Data File 
    % and Body Number Within this File.   
body(1).geometryFile = 'geometry/float.SLDPRT';    % Location of Geometry File
body(1).mass = 'equilibrium';
% body(1).mass = 33384;  This doesn't work                 
    % Body Mass. The 'equilibrium' Option Sets it to the Displaced Water 
    % Weight.
body(1).inertia = [1041149 1041149 2145160];  % Moment of Inertia [kg*m^2]

% Spar/Plate ("\AOEStruct.ini")
body(2) = bodyClass('hydroData/AOE_1device.h5'); 
body(2).geometryFile = 'geometry/stabilizer.SLDPRT'; 
body(2).mass = 'equilibrium';
% body(2).mass = 167985; This doesn't work
body(2).inertia = [14597859 14597859 998029];
